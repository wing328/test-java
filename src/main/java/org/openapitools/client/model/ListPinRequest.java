...
public class ListPinRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListPinRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListPinRequest.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListPinRequest is not found in the empty JSON string", ListPinRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListPinRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListPinRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
