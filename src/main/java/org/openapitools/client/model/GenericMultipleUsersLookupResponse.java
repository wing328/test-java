...
import org.openapitools.client.model.GenericMultipleUsersLookupResponseMeta;
...
public class GenericMultipleUsersLookupResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericMultipleUsersLookupResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenericMultipleUsersLookupResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericMultipleUsersLookupResponse is not found in the empty JSON string", GenericMultipleUsersLookupResponse.openapiRequiredFields.toString()));
        }
      }
 ...
 /**
  * Create an instance of GenericMultipleUsersLookupResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenericMultipleUsersLookupResponse
  * @throws IOException if the JSON string is invalid with respect to GenericMultipleUsersLookupResponse
  */
  public static GenericMultipleUsersLookupResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericMultipleUsersLookupResponse.class);
  }

 /**
  * Convert an instance of GenericMultipleUsersLookupResponse to an JSON string
  *
  * @return JSON string
  */
