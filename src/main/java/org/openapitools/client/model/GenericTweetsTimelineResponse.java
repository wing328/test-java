  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenericTweetsTimelineResponse.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericTweetsTimelineResponse is not found in the empty JSON string", GenericTweetsTimelineResponse.openapiRequiredFields.toString()));
        }
      }
