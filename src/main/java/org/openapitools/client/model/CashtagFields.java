...
public class CashtagFields {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CashtagFields
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CashtagFields.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in CashtagFields is not found in the empty JSON string", CashtagFields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CashtagFields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CashtagFields` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
