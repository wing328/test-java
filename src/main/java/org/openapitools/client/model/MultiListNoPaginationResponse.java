...
import org.openapitools.client.model.MultiListNoPaginationResponseMeta;
...
public class MultiListNoPaginationResponse {
  ...
  public MultiListNoPaginationResponse data(List<ModelList> data) {
    
    this.data = data;
    return this;
  }

  public MultiListNoPaginationResponse addDataItem(ModelList dataItem) {
    if (this.data == null) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MultiListNoPaginationResponse
  */
 ...
 /**
  * Create an instance of MultiListNoPaginationResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MultiListNoPaginationResponse
  * @throws IOException if the JSON string is invalid with respect to MultiListNoPaginationResponse
  */
  public static MultiListNoPaginationResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultiListNoPaginationResponse.class);
  }

 /**
  * Convert an instance of MultiListNoPaginationResponse to an JSON string
  *
  * @return JSON string
  */
