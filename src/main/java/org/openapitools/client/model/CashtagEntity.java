...
import org.openapitools.client.model.CashtagFields;
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CashtagEntity.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) `%s` is not found in the empty JSON string", CashtagEntity.openapiRequiredFields.toString()));
        }
      }
