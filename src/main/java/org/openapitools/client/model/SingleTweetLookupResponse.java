...
public class SingleTweetLookupResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SingleTweetLookupResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SingleTweetLookupResponse.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SingleTweetLookupResponse is not found in the empty JSON string", SingleTweetLookupResponse.openapiRequiredFields.toString()));
        }
      }
