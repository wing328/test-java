...
public class GenericProblemAllOf {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericProblemAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenericProblemAllOf.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericProblemAllOf is not found in the empty JSON string", GenericProblemAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenericProblemAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenericProblemAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
