...
public class GenericMultipleUsersLookupResponseMeta {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericMultipleUsersLookupResponseMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GenericMultipleUsersLookupResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenericMultipleUsersLookupResponseMeta` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
