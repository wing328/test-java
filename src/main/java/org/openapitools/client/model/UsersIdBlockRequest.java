...
public class UsersIdBlockRequest {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UsersIdBlockRequest.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in UsersIdBlockRequest is not found in the empty JSON string", UsersIdBlockRequest.openapiRequiredFields.toString()));
        }
      }
