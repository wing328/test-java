...
import org.openapitools.client.model.HideReplyByIdResponseData;
...
public class HideReplyByIdResponse {
 ...
 /**
  * Create an instance of HideReplyByIdResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HideReplyByIdResponse
  * @throws IOException if the JSON string is invalid with respect to HideReplyByIdResponse
  */
  public static HideReplyByIdResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HideReplyByIdResponse.class);
  }

 /**
  * Convert an instance of HideReplyByIdResponse to an JSON string
  *
  * @return JSON string
  */
