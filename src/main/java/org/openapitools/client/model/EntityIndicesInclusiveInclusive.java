...
public class EntityIndicesInclusiveInclusive {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EntityIndicesInclusiveInclusive.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) `%s` is not found in the empty JSON string", EntityIndicesInclusiveInclusive.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EntityIndicesInclusiveInclusive.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EntityIndicesInclusiveInclusive` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
