...
public class ListCreateRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListCreateRequest.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCreateRequest is not found in the empty JSON string", ListCreateRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  * @return An instance of ListCreateRequest
  * @throws IOException if the JSON string is invalid with respect to ListCreateRequest
  */
  public static ListCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCreateRequest.class);
  }
