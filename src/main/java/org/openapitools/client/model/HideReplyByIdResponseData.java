...
public class HideReplyByIdResponseData {
 ...
 /**
  * Create an instance of HideReplyByIdResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HideReplyByIdResponseData
  * @throws IOException if the JSON string is invalid with respect to HideReplyByIdResponseData
  */
  public static HideReplyByIdResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HideReplyByIdResponseData.class);
  }

 /**
  * Convert an instance of HideReplyByIdResponseData to an JSON string
  *
  * @return JSON string
  */
