...
import org.openapitools.client.model.GenericProblemAllOf;
...
public class GenericProblem extends Problem {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, genericProblem.status) &&
        super.equals(o);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (GenericProblem.openapiRequiredFields.isEmpty()) {
          ...
          throw new IllegalArgumentException(String.format("The required field(s) `%s` is not found in the empty JSON string", GenericProblem.openapiRequiredFields.toString()));
        }
      }
